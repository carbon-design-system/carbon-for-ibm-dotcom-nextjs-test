...
const WhiteThemeExample = () => (
  <>
        ...
        <div className="bx--col-sm-4 bx--col-lg-12 bx--offset-lg-4">
          <DDSContentGroupBanner>
            <DDSContentGroupHeading>
              Content group banner: a subtle callout for tangential information
              or announcements
            </DDSContentGroupHeading>
    ...
    <DDSCardSectionCarousel>
      <DDSContentSectionHeading>Card section carousel</DDSContentSectionHeading>
      <DDSContentSectionCopy>
        Allows users to explore multiple pieces of content within the same area
      </DDSContentSectionCopy>
      <DDSLinkWithIcon
        slot="footer"
      ...
      <DDSCarousel>
        <DDSCard href="https://www.ibm.com/standards/web/carbon-for-ibm-dotcom/components/card-section-carousel">
          ...
          The main content of the carousel lives on these cards. You can use any
          variation of the card component to populate the carousel.
          <DDSCardFooter>
            <ArrowRight20 slot="icon" />
          </DDSCardFooter>
        </DDSCard>
        <DDSCard href="https://www.ibm.com/standards/web/carbon-for-ibm-dotcom/components/card-section-carousel">
          ...
          navigational controls for browsing the carousel. They are required in
          this component.
          <DDSCardFooter>
            <ArrowRight20 slot="icon" />
          </DDSCardFooter>
        ...
        <DDSCard href="https://www.ibm.com/standards/web/carbon-for-ibm-dotcom/components/card-section-carousel">
          ...
          The recommended amount of content is a minimum of 5 cards and maximum
          of 15 cards to avoid excessive clicking for the user.
          <DDSCardFooter>
            <ArrowRight20 slot="icon" />
          </DDSCardFooter>
        </DDSCard>
        <DDSCard href="https://www.ibm.com/standards/web/carbon-for-ibm-dotcom/components/card-section-carousel">
          ...
          Do not add essential content to a carousel. Essential content could
          include navigational or wayfinding content links.
          <DDSCardFooter>
            <ArrowRight20 slot="icon" />
          </DDSCardFooter>
        </DDSCard>
        ...
        <DDSCard href="https://www.ibm.com/standards/web/carbon-for-ibm-dotcom/components/card-section-carousel">
          ...
          Common content used in carousels includes use cases, news articles,
